...
class KotlinIconProvider : IconProvider() {
  ...
  override fun getIcon(p0: PsiElement, p1: Int): Icon? {
    ...
    if (p0 !is KtClassOrObject)
      return if (PsiUtilCore.getVirtualFile(p0)?.name?.endsWith(".kt") == true) icons.kotlin
      else null
